  ...
  return (
    <div className="w-full animate-pulse" style={{ backgroundColor: "var(--bg-primary)" }}>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8">
        {/* Header skeleton */}
        <div className="mb-6">
          <div className="h-8 w-56 rounded" style={{ backgroundColor: "var(--bg-elevated)" }} />
          <div className="mt-3 h-4 w-96 max-w-full rounded" style={{ backgroundColor: "var(--bg-elevated)" }} />
        </div>
